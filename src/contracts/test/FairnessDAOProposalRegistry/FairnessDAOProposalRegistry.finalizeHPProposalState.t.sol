...
contract FairnessDAOProposalRegistryFinalizeHPProposalStateTest is
    Test,
    InitFairnessDAOProposalRegistry
{
    ...
    function setUp() public virtual override {
        ...
        /// @dev We set random default values with an HP level.
    ...
    function test_finalizeProposal_func_HardProposalDoesNotMeetQuorumAccount()
        public
    {
        ...
        skip(28 days);
        /// @dev 28 days is the voting duration of an HP proposal level.
        fairnessDAOProposalRegistry.finalizeProposal(initialProposalId);
    ...
    function test_finalizeProposal_func_HardProposalDoesNotMeetQuorumToken()
        public
    {
        vm.stopPrank();
    ...
    function test_finalizeProposal_func_HardProposalMeetsCompleteQuorumButTies()
        public
    {
        skip(defaultStartTime);

        /// @dev With the vote from this voter (which has the majority of the voting supply), the contract can confirm the quantity threshold.
        ...
        for (uint256 i = 1; i < 11;) {
            ...
            mockERC20.approve(address(fairnessDAOFairVesting), tmpAmountToVest);
            fairnessDAOFairVesting.initiateVesting(tmpAmountToVest);
            /// @dev the same amount of time is elasped before each vote
